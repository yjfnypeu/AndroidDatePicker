package org.lzh.datepickerlib.wheel;
...
public class WheelView extends TosGallery {
    ...
    /**
     * All of custom config defined by xml
     */
...
//        drawShadows(canvas);
    ...
    /**
     * @see org.lzh.datepickerlib.wheel.TosGallery#setSelectedPositionInt(int)
     */
    @Override
    ...
    /** 
     * All of custom configs
     */
    static class Config {
    	int bgResId = R.drawable.wheel_bg;
    	int[] topShadow = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
    	int[] bottomShadow = new int[] { 0xFF111111, 0x00AAAAAA, 0x00AAAAAA };
    }
}
